...
void MainWindow::saveSettings() {
  ...
  color = ui->pushButton_widgetColor->palette().color(QPalette::Window);
  ...
  color = ui->pushButton_lineColor->palette().color(QPalette::Window);
  settings->setValue("LineR", color.red());
  settings->setValue("LineG", color.green());
  settings->setValue("LineB", color.blue());
  color = ui->pushButton_vertexColor->palette().color(QPalette::Window);
